...
<div class="mx-auto max-w-7xl px-4 py-8 md:px-8" style="font-family: 'DM Sans', sans-serif;">
	<!-- Header -->
	<div class="mb-8">
		<p class="mb-1 text-[11px] font-medium uppercase tracking-[0.12em] text-white/25">Analytics</p>
	...
	<div class="rounded-2xl border border-white/[0.04] bg-white/[0.02] p-12 text-center transition-all duration-500 {visible ? 'translate-y-0 opacity-100' : 'translate-y-3 opacity-0'}">
		...
		<h3 class="mt-5 font-['Instrument_Serif'] text-xl text-white">Analytics coming soon</h3>
		...
		<div class="mx-auto mt-8 grid max-w-2xl grid-cols-1 gap-3 sm:grid-cols-3">
			{#each [
				...
				<div class="flex flex-col items-center gap-2 rounded-xl border border-white/[0.04] p-4">
					<div class="flex h-9 w-9 items-center justify-center rounded-lg bg-white/[0.03]">
